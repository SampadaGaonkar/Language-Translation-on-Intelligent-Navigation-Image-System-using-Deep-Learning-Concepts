...
# DEFINE FUNCTION
image_tt1 = cv2.imread("shapes/tt1.jpg")
image_tt2 = cv2.imread("shapes/tt2.jpg")
...
if( image_upload.shape == image_tt2.shape  ):
    ...
    text2 = re.findall(r'[A-Z][A-Z]+', text1)
...
elif(image_upload.shape == image_tt1.shape ):
