...
#C:/Users/DELL/Desktop/Just replace these/FrenchDataset

#loading test dataset
filename = os.path.abspath('C:/Users/Sanju/Desktop/pics/translation/Just replace these/FrenchDataset/test.txt')
test = load_doc(filename)
print(test)
cp = clean_sentence(test)
save_clean_data(cp,'test1.pkl')
test = load_clean_sentences('test1.pkl')
print(test)
...
# load model
model = load_model('FrenchModel.h5')
